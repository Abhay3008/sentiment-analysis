...
#path for dataset
INPUT_PATH = "/content/fer13-cleaned-dataset/"
...
#splitting dataset into training and testing use.
...
#using mobilenet architecture for training module
